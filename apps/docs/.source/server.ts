...
import * as __fd_glob_7 from "../../../content/frontend/javascript/closures.mdx?collection=docs"
...
export const docs = await create.docs("docs", "../../content", {"roadmaps/frontend.json": __fd_glob_0, }, {"backend/node/async-await.mdx": __fd_glob_1, "backend/node/event-loop.mdx": __fd_glob_2, "database/sql/indexes.mdx": __fd_glob_3, "database/sql/queries.mdx": __fd_glob_4, "database/sql/transactions.mdx": __fd_glob_5, "frontend/react/rendering.mdx": __fd_glob_6, "frontend/javascript/closures.mdx": __fd_glob_7, "frontend/react/hook/use-effect.mdx": __fd_glob_8, "frontend/react/hook/use-state.mdx": __fd_glob_9, });