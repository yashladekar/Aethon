...
- [ ] 1. Fix `apps/docs` layout bug and wire up Fumadocs
...
- [ ] 2. Formalize Topic Schema in `packages/content-core`
...
- [ ] 3. Build Content Registry in `packages/content-core`
...
- [ ] 4. Add sample MDX content files
...
- [ ] 5. Expand `packages/shared` with domain contract modules
...
- [ ] 6. Implement `packages/graph-engine`
...
- [ ] 16. Verify Prisma schema completeness and run migration
